  ...
  return (
    <>
      <Routes>
        ...
        <Route path="/student/my-courses" element={auth.isLoggedIn ? <AppLayout userType="student" onLogoutClick={() => setIsLogoutModalOpen(true)}><MyCoursesPage /></AppLayout> : <Navigate to="/login" />} />
