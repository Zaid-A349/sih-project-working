import { 
  LayoutDashboard, Book, Award, Briefcase, LogOut, Users, 
  FileBarChart, Settings, FileText 
} from 'lucide-react';
import { useState } from 'react'; // Re-added useState
import studentAvatar from '../../assets/student-avatar.png';

const Logo = () => (
    <svg width="40" height="40" viewBox="0 0 40 40" fill="none" xmlns="http://www.w3.org/2000/svg"><path d="M20 4L4 12L20 20L36 12L20 4Z" fill="#6366F1"/><path d="M4 28L20 36L36 28V12L20 20V36L4 28V12L12 16" stroke="#C7D2FE" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"/><path d="M36 12V28" stroke="#4F46E5" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"/><path d="M4 12V28" stroke="#4F46E5" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"/></svg>
);
...
// Removed the 'path' properties from the menu config
const menuConfig = {
  student: {
    links: [
      ...
      { icon: <FileText size={20} />, text: "My Document" }, 
      { icon: <Briefcase size={20} />, text: "Generate Portfolio" }, 
    ],
    ...
    <aside className="h-screen sticky top-0">
      <nav className="h-full flex flex-col bg-white border-r shadow-sm">
        ...
        <div className="border-t px-3">
          <li onClick={onLogoutClick} className="relative flex items-center py-3 px-4 my-1 font-medium rounded-md cursor-pointer transition-colors group hover:bg-indigo-50 text-gray-600">
            <LogOut size={20} /><span className="w-52 ml-3">Log Out</span>
          </li>
        </div>
