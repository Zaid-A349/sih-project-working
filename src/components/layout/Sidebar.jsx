...
import { useState } from "react"; // Using useState for local active state
...
// This is now a simple list item with an onClick handler
...
// All 'path' properties have been removed
const menuConfig = {
  student: {
    links: [
